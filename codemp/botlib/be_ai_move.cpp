...
{
	const bsp_trace_t trace = AAS_Trace(eye, NULL, NULL, target, ent, CONTENTS_SOLID | CONTENTS_PLAYERCLIP);
...
void BotMoveToGoal(bot_moveresult_t* result, int movestate, bot_goal_t* goal, int travelflags)
{
	...
	else
	{
		...
		const int numareas = AAS_TraceAreas(ms->origin, end, areas, NULL, 16);
