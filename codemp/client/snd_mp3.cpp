...
float MP3Stream_GetPlayingTimeInSeconds(LP_MP3STREAM lpMP3Stream)
{
	if (lpMP3Stream->iTimeQuery_UnpackedLength)	// fields initialised?
		return static_cast<float>((((double)lpMP3Stream->iTimeQuery_UnpackedLength / (double)lpMP3Stream->iTimeQuery_SampleRate) / (
			double)lpMP3Stream->iTimeQuery_Channels) / (double)lpMP3Stream->iTimeQuery_Width);
...
{
	if (lpMP3Stream->iTimeQuery_UnpackedLength)	// fields initialised?
		return static_cast<float>(((((double)(lpMP3Stream->iTimeQuery_UnpackedLength - (lpMP3Stream->iBytesDecodedTotal * (lpMP3Stream
			->iTimeQuery_SampleRate / dma.speed)))) / (double)lpMP3Stream->iTimeQuery_SampleRate) / (double)lpMP3Stream->
			iTimeQuery_Channels) / (double)lpMP3Stream->iTimeQuery_Width);
