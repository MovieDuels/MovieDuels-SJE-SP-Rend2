...
stringID_table_t animTable[MAX_ANIMATIONS + 1] =
{
	...
	ENUM2STRING(BOTH_A6_SABERPROTECT_GRIEVOUS),
	...
	ENUM2STRING(BOTH_A2_SPECIAL_ANAKIN),
	///////////////////////////////////////////
	...
	ENUM2STRING(BOTH_SPRINT_ANI_LIGHTSABER),
	ENUM2STRING(BOTH_SPRINT_ANI_STAFF_LIGHTSABER),
