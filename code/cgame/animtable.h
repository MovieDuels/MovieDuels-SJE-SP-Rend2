...
stringID_table_t animTable[MAX_ANIMATIONS + 1] =
{
	...
	///////////////////////////////////////
	ENUM2STRING(BOTH_A1_SPECIAL_YODA),
	ENUM2STRING(BOTH_A6_SABERPROTECT_GRIEV),
	///////////////////////////////////////////
	ENUM2STRING(BOTH_STABDOWN_WINDU),
	ENUM2STRING(BOTH_SMASHDOWN_DUAL),
	ENUM2STRING(BOTH_SMASHDOWN_SINGLE),
	ENUM2STRING(BOTH_SMASHDOWN_STAFF),
	//////////////////////////////////////////
		// ANAKIN CS_ANAKIN
	ENUM2STRING(BOTH_A2_SPECIAL_ANI),
	ENUM2STRING(BOTH_WALK1_ANI), //# Normal walk
	ENUM2STRING(BOTH_WALK2_ANI),
	ENUM2STRING(BOTH_WALK_DUAL_ANI),
	ENUM2STRING(BOTH_RUN1_ANI),
	ENUM2STRING(BOTH_RUN2_ANI),
	ENUM2STRING(BOTH_RUN_DUAL_ANI),
	ENUM2STRING(BOTH_RUN_STAFF_ANI),
	ENUM2STRING(BOTH_SPRINT_SINGLE_LIGHTSABER_ANI),
	ENUM2STRING(BOTH_SPRINT_STAFF_LIGHTSABER_ANI),
	ENUM2STRING(BOTH_STAND2IDLE1_ANI),
	ENUM2STRING(BOTH_STAND9IDLE1_ANI),
	ENUM2STRING(BOTH_STAND_BLOCKING_ON_ANI),
	ENUM2STRING(BOTH_STAND_BLOCKING_ON_LEFT_ANI),
	ENUM2STRING(BOTH_STAND_BLOCKING_ON_RIGHT_ANI),
	ENUM2STRING(BOTH_STAND_BLOCKING_ON_FORWARD_ANI),
	ENUM2STRING(BOTH_STAND_BLOCKING_ON_BACK_ANI),
	ENUM2STRING(BOTH_STAND_BLOCKING_ON_DUAL_ANI),
	ENUM2STRING(BOTH_SABERFAST_STANCE_JKA_ANI),
	ENUM2STRING(BOTH_SABERDESANN_STANCE_JKA_ANI),
	ENUM2STRING(BOTH_SABERSINGLECROUCH_ANI),
	ENUM2STRING(BOTH_SABERSLOW_STANCE_JKA_ANI),
	ENUM2STRING(BOTH_FLIP_B_ANI),
	ENUM2STRING(BOTH_FLIP_F_ANI),
	ENUM2STRING(BOTH_FLIP_L_ANI),
	ENUM2STRING(BOTH_FLIP_R_ANI),
	ENUM2STRING(BOTH_FORCEGRIP_RELEASE_ANI),
	ENUM2STRING(BOTH_FORCEGRIP1_ANI),
	ENUM2STRING(BOTH_INAIR1_ANI),
	ENUM2STRING(BOTH_JUMP1_ANI),
	ENUM2STRING(BOTH_LAND1_ANI),
	//////////////////////////////////////////
