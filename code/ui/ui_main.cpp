...
vmCvar_t ui_SFXSabersGlowSizeCW;
vmCvar_t ui_SFXSabersCoreSizeCW;
vmCvar_t ui_SFXSabersGlowSizeMaul;
vmCvar_t ui_SFXSabersCoreSizeMaul;
...
static cvarTable_t cvarTable[] =
{
	...
	{&ui_SFXSabersGlowSizeRebels, "cg_SFXSabersGlowSizeRebels", "1.0", nullptr, CVAR_ARCHIVE},
	{&ui_SFXSabersCoreSizeRebels, "cg_SFXSabersCoreSizeRebels", "1.0", nullptr, CVAR_ARCHIVE},
	{&ui_SFXSabersGlowSizeCW, "cg_SFXSabersGlowSizeCW", "1.0", nullptr, CVAR_ARCHIVE},
	{&ui_SFXSabersCoreSizeCW, "cg_SFXSabersCoreSizeCW", "1.0", nullptr, CVAR_ARCHIVE},
...
void UI_LoadMenus(const char* menuFile, const qboolean reset)
{
	...
	Com_Printf("--------------------- Build Date 07/06/2026 ---------------------\n");// build date
	Com_Printf("--------------------------- Build 04 ----------------------------\n");
	Com_Printf("-----------------------------------------------------------------\n");
