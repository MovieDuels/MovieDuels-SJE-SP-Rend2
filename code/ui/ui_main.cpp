...
static constexpr charMD_t charMD[] = {
	...
	{ "Revan",							"[Star Forge - Masked]",				"",				"md_revan_jedi",				"revan_jedi",			"model_default",				"revan_jedi",				"",						"purple",		"",			1,		30,		ERA_OLD_REPUBLIC,	BOTH_SABERSLOW_STANCE_JKA,			BOTH_PAIN1,			BOTH_PAIN2,			"sound/chars/revan/misc/victory1.mp3",				"",		1.0f,	"@MD_CHAR_DESC_DARTH_REVAN",				qfalse },
	{ "Revan",							"[Star Forge - Unmasked]",				"",				"md_revan_jedi_nomask",			"revan_jedi",			"model_nomask",					"revan_jedi",				"",						"purple",		"",			1,		30,		ERA_OLD_REPUBLIC,	BOTH_SABERSLOW_STANCE_JKA,			BOTH_PAIN1,			BOTH_PAIN2,			"sound/chars/revan/misc/victory1.mp3",				"",		1.0f,	"@MD_CHAR_DESC_DARTH_REVAN",				 qtrue },
	{ "Revan",							"[Star Forge]",							"",				"md_revan_jedi_nomask_nh",		"revan_jedi",			"model_nomask_nohood",			"revan_jedi",				"",						"purple",		"",			1,		30,		ERA_OLD_REPUBLIC,	BOTH_SABERSLOW_STANCE_JKA,			BOTH_PAIN1,			BOTH_PAIN2,			"sound/chars/revan/misc/victory1.mp3",				"",		1.0f,	"@MD_CHAR_DESC_DARTH_REVAN",				 qtrue },
	{ "Revan",							"[Mandalorian Wars - Masked]",			"",				"md_revan_mw",					"revan_mw",				"model_default",				"revan_jedi",				"",						"blue",			"",			1,		30,		ERA_OLD_REPUBLIC,	BOTH_SABERSLOW_STANCE_JKA,			BOTH_PAIN1,			BOTH_PAIN2,			"sound/chars/revan/misc/victory1.mp3",				"",		1.0f,	"@MD_CHAR_DESC_DARTH_REVAN",				 qtrue },
	{ "Revan",							"[Mandalorian Wars - Unmasked]",		"",				"md_revan_mw_nomask",			"revan_mw",				"model_nomask",					"revan_jedi",				"",						"blue",			"",			1,		30,		ERA_OLD_REPUBLIC,	BOTH_SABERSLOW_STANCE_JKA,			BOTH_PAIN1,			BOTH_PAIN2,			"sound/chars/revan/misc/victory1.mp3",				"",		1.0f,	"@MD_CHAR_DESC_DARTH_REVAN",				 qtrue },
	{ "Revan",							"[Mandalorian Wars]",					"",				"md_revan_mw_nomask_nh",		"revan_mw",				"model_nomask_nohood",			"revan_jedi",				"",						"blue",			"",			1,		30,		ERA_OLD_REPUBLIC,	BOTH_SABERSLOW_STANCE_JKA,			BOTH_PAIN1,			BOTH_PAIN2,			"sound/chars/revan/misc/victory1.mp3",				"",		1.0f,	"@MD_CHAR_DESC_DARTH_REVAN",				 qtrue },
...
void UI_LoadMenus(const char* menuFile, const qboolean reset)
{
	...
	Com_Printf("-------------------- Build Date 23/12/2025 ----------------------\n");
	Com_Printf("-----------------------------------------------------------------\n");
