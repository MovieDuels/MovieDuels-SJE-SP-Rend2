...
static void CM_PreparePatchCollide(const int num)
{
...
====================
*/
static int CM_CheckFacetPlane(const float* plane, vec3_t start, vec3_t end, float* enter_frac, float* leave_frac, int* hit) {
	float f;
