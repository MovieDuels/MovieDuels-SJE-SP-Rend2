...
#define VERSION_INTERNAL_BUILD	    10  // Build day

#define VERSION_STRING				"Day-10,Month-04,Year-26,BuildNum-04" // build date
#define VERSION_STRING_DOTTED		"Day-10,Month-04,Year-26,BuildNum-04" // build date
