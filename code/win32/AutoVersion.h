...
#define VERSION_INTERNAL_BUILD		19  // Build day

#define VERSION_STRING				"Day-19,Month-04,Year-26,BuildNum-09" // build date
#define VERSION_STRING_DOTTED		"Day-19,Month-04,Year-26,BuildNum-09" // build date
