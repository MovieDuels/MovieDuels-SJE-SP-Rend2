...
#define VERSION_INTERNAL_BUILD	    03  // Build day

#define VERSION_STRING				"Day-03,Month-04,Year-26,BuildNum-01" // build date
#define VERSION_STRING_DOTTED		"Day-03,Month-04,Year-26,BuildNum-01" // build date
