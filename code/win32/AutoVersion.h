...
#define VERSION_INTERNAL_BUILD		07  // Build day

#define VERSION_STRING				"Day-07,Month-01,Year-26,BuildNum-07" // build date
#define VERSION_STRING_DOTTED		"Day-07,Month-01,Year-26,BuildNum-07" // build date
