...
#define VERSION_INTERNAL_BUILD		11  // Build day

#define VERSION_STRING				"Day-11,Month-05,Year-26,BuildNum-08" // build date
#define VERSION_STRING_DOTTED		"Day-11,Month-05,Year-26,BuildNum-08" // build date
