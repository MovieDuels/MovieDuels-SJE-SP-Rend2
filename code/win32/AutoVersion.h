...
#define VERSION_INTERNAL_BUILD		25  // Build day

#define VERSION_STRING				"Day-25,Month-06,Year-26,BuildNum-10" // build date
#define VERSION_STRING_DOTTED		"Day-25,Month-06,Year-26,BuildNum-10" // build date
