...
#define VERSION_INTERNAL_BUILD		05  // Build day

#define VERSION_STRING				"Day-05,Month-01,Year-26,BuildNum-07" // build date
#define VERSION_STRING_DOTTED		"Day-05,Month-01,Year-26,BuildNum-07" // build date
