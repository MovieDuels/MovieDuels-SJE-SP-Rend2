...
extern void SetMiscModelDefaults(gentity_t* ent, useFunc_t use_func, const char* material, int solid_mask, int animFlag, qboolean take_damage, qboolean damage_model);
...
void station_pain(gentity_t* self, gentity_t* inflictor, gentity_t* other, const vec3_t point, int damage, int mod, int hit_loc)
{
