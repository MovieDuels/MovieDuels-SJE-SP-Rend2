...
-------------------------
*/
static void Wampa_Move(const qboolean visible)
{
...
static void Wampa_Slash(const int bolt_index, const qboolean backhand)
{
...
//------------------------------
static void Wampa_Attack(const float distance, const qboolean do_charge)
{
