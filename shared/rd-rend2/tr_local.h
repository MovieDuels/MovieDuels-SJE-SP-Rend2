...
void* R_Malloc(const int iSize, const memtag_t eTag, const qboolean b_zeroit);
#endif
...
void G2_SetSurfaceOnOffFromSkin(CGhoul2Info* ghlInfo, const qhandle_t render_skin);	//tr_ghoul2.cpp
//#endif
